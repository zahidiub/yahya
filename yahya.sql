...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2014 at 03:36 PM
...
--
-- Table structure for table `yq_address`
--

CREATE TABLE IF NOT EXISTS `yq_address` (
...
--
-- Table structure for table `yq_affiliate`
--

CREATE TABLE IF NOT EXISTS `yq_affiliate` (
...
--
-- Table structure for table `yq_affiliate_transaction`
--

CREATE TABLE IF NOT EXISTS `yq_affiliate_transaction` (
...
--
-- Table structure for table `yq_attribute`
--

CREATE TABLE IF NOT EXISTS `yq_attribute` (
...
--
-- Dumping data for table `yq_attribute`
--

INSERT INTO `yq_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `yq_attribute_description`
--

CREATE TABLE IF NOT EXISTS `yq_attribute_description` (
...
--
-- Dumping data for table `yq_attribute_description`
--

INSERT INTO `yq_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- Table structure for table `yq_attribute_group`
--

CREATE TABLE IF NOT EXISTS `yq_attribute_group` (
...
--
-- Dumping data for table `yq_attribute_group`
--

INSERT INTO `yq_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `yq_attribute_group_description`
--

CREATE TABLE IF NOT EXISTS `yq_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `yq_attribute_group_description`
--

INSERT INTO `yq_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
--
-- Table structure for table `yq_banner`
--

CREATE TABLE IF NOT EXISTS `yq_banner` (
...
--
-- Dumping data for table `yq_banner`
--

INSERT INTO `yq_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
(7, 'Samsung Tab', 1),
(8, 'Manufacturers', 1);
...
--
-- Table structure for table `yq_banner_image`
--

CREATE TABLE IF NOT EXISTS `yq_banner_image` (
...
--
-- Dumping data for table `yq_banner_image`
--

INSERT INTO `yq_banner_image` (`banner_image_id`, `banner_id`, `link`, `image`) VALUES
...
--
-- Table structure for table `yq_banner_image_description`
--

CREATE TABLE IF NOT EXISTS `yq_banner_image_description` (
...
--
-- Dumping data for table `yq_banner_image_description`
--

INSERT INTO `yq_banner_image_description` (`banner_image_id`, `language_id`, `banner_id`, `title`) VALUES
...
CREATE TABLE IF NOT EXISTS `yq_category` (
...
INSERT INTO `yq_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `yq_category_description`
--

CREATE TABLE IF NOT EXISTS `yq_category_description` (
...
--
-- Dumping data for table `yq_category_description`
--

INSERT INTO `yq_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`) VALUES
(28, 1, 'Monitors', '', '', ''),
(33, 1, 'Cameras', '', '', ''),
(32, 1, 'Web Cameras', '', '', ''),
(31, 1, 'Scanners', '', '', ''),
...
--
-- Table structure for table `yq_category_filter`
--

CREATE TABLE IF NOT EXISTS `yq_category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_category_path`
--

CREATE TABLE IF NOT EXISTS `yq_category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `yq_category_path`
--

INSERT INTO `yq_category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 25, 0),
...
--
-- Table structure for table `yq_category_to_layout`
--

CREATE TABLE IF NOT EXISTS `yq_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_category_to_store`
--

CREATE TABLE IF NOT EXISTS `yq_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `yq_category_to_store`
--

INSERT INTO `yq_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Table structure for table `yq_country`
--

CREATE TABLE IF NOT EXISTS `yq_country` (
...
--
-- Dumping data for table `yq_country`
--

INSERT INTO `yq_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Table structure for table `yq_coupon`
--

CREATE TABLE IF NOT EXISTS `yq_coupon` (
...
--
-- Dumping data for table `yq_coupon`
--

INSERT INTO `yq_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `yq_coupon_category`
--

CREATE TABLE IF NOT EXISTS `yq_coupon_category` (
...
--
-- Table structure for table `yq_coupon_history`
--

CREATE TABLE IF NOT EXISTS `yq_coupon_history` (
...
--
-- Table structure for table `yq_coupon_product`
--

CREATE TABLE IF NOT EXISTS `yq_coupon_product` (
...
--
-- Table structure for table `yq_currency`
--

CREATE TABLE IF NOT EXISTS `yq_currency` (
...
--
-- Dumping data for table `yq_currency`
--

INSERT INTO `yq_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.58639997, 1, '2014-06-20 10:57:32'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2014-06-20 12:16:18'),
(3, 'Euro', 'EUR', '', '€', '2', 0.73470002, 1, '2014-06-20 10:57:32');

-- --------------------------------------------------------

--
-- Table structure for table `yq_customer`
--

CREATE TABLE IF NOT EXISTS `yq_customer` (
...
--
-- Table structure for table `yq_customer_ban_ip`
--

CREATE TABLE IF NOT EXISTS `yq_customer_ban_ip` (
...
--
-- Table structure for table `yq_customer_field`
--

CREATE TABLE IF NOT EXISTS `yq_customer_field` (
  `customer_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_customer_group`
--

CREATE TABLE IF NOT EXISTS `yq_customer_group` (
...
--
-- Dumping data for table `yq_customer_group`
--

INSERT INTO `yq_customer_group` (`customer_group_id`, `approval`, `company_id_display`, `company_id_required`, `tax_id_display`, `tax_id_required`, `sort_order`) VALUES
(1, 0, 1, 0, 0, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `yq_customer_group_description`
--

CREATE TABLE IF NOT EXISTS `yq_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `yq_customer_group_description`
--

INSERT INTO `yq_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');

-- --------------------------------------------------------

--
-- Table structure for table `yq_customer_history`
--

CREATE TABLE IF NOT EXISTS `yq_customer_history` (
...
--
-- Table structure for table `yq_customer_ip`
--

CREATE TABLE IF NOT EXISTS `yq_customer_ip` (
...
--
-- Table structure for table `yq_customer_online`
--

CREATE TABLE IF NOT EXISTS `yq_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
--
-- Table structure for table `yq_customer_reward`
--

CREATE TABLE IF NOT EXISTS `yq_customer_reward` (
...
--
-- Table structure for table `yq_customer_transaction`
--

CREATE TABLE IF NOT EXISTS `yq_customer_transaction` (
...
--
-- Table structure for table `yq_custom_field`
--

CREATE TABLE IF NOT EXISTS `yq_custom_field` (
...
--
-- Table structure for table `yq_custom_field_description`
--

CREATE TABLE IF NOT EXISTS `yq_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
--
-- Table structure for table `yq_custom_field_to_customer_group`
--

CREATE TABLE IF NOT EXISTS `yq_custom_field_to_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_custom_field_value`
--

CREATE TABLE IF NOT EXISTS `yq_custom_field_value` (
...
--
-- Table structure for table `yq_custom_field_value_description`
--

CREATE TABLE IF NOT EXISTS `yq_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
--
-- Table structure for table `yq_download`
--

CREATE TABLE IF NOT EXISTS `yq_download` (
...
--
-- Table structure for table `yq_download_description`
--

CREATE TABLE IF NOT EXISTS `yq_download_description` (
...
--
-- Table structure for table `yq_extension`
--

CREATE TABLE IF NOT EXISTS `yq_extension` (
...
--
-- Dumping data for table `yq_extension`
--

INSERT INTO `yq_extension` (`extension_id`, `type`, `code`) VALUES
(23, 'payment', 'cod'),
(22, 'total', 'shipping'),
(57, 'total', 'sub_total'),
(58, 'total', 'tax'),
...
--
-- Table structure for table `yq_filter`
--

CREATE TABLE IF NOT EXISTS `yq_filter` (
...
--
-- Table structure for table `yq_filter_description`
--

CREATE TABLE IF NOT EXISTS `yq_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Table structure for table `yq_filter_group`
--

CREATE TABLE IF NOT EXISTS `yq_filter_group` (
...
--
-- Table structure for table `yq_filter_group_description`
--

CREATE TABLE IF NOT EXISTS `yq_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Table structure for table `yq_geo_zone`
--

CREATE TABLE IF NOT EXISTS `yq_geo_zone` (
...
--
-- Dumping data for table `yq_geo_zone`
--

INSERT INTO `yq_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
...
--
-- Table structure for table `yq_information`
--

CREATE TABLE IF NOT EXISTS `yq_information` (
...
--
-- Dumping data for table `yq_information`
--

INSERT INTO `yq_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3, 1, 3, 1),
(4, 1, 1, 1),
(5, 1, 4, 1),
(6, 1, 2, 1);
...
--
-- Table structure for table `yq_information_description`
--

CREATE TABLE IF NOT EXISTS `yq_information_description` (
...
--
-- Dumping data for table `yq_information_description`
--

INSERT INTO `yq_information_description` (`information_id`, `language_id`, `title`, `description`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n'),
...
--
-- Table structure for table `yq_information_to_layout`
--

CREATE TABLE IF NOT EXISTS `yq_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_information_to_store`
--

CREATE TABLE IF NOT EXISTS `yq_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `yq_information_to_store`
--

INSERT INTO `yq_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
--
-- Table structure for table `yq_language`
--

CREATE TABLE IF NOT EXISTS `yq_language` (
...
--
-- Dumping data for table `yq_language`
--

INSERT INTO `yq_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES
(1, 'English', 'en', 'en_US.UTF-8,en_US,en-gb,english', 'gb.png', 'english', 'english', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `yq_layout`
--

CREATE TABLE IF NOT EXISTS `yq_layout` (
...
--
-- Dumping data for table `yq_layout`
--

INSERT INTO `yq_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Table structure for table `yq_layout_route`
--

CREATE TABLE IF NOT EXISTS `yq_layout_route` (
...
--
-- Dumping data for table `yq_layout_route`
--

INSERT INTO `yq_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(30, 6, 0, 'account'),
(17, 10, 0, 'affiliate/'),
...
--
-- Table structure for table `yq_length_class`
--

CREATE TABLE IF NOT EXISTS `yq_length_class` (
...
--
-- Dumping data for table `yq_length_class`
--

INSERT INTO `yq_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Table structure for table `yq_length_class_description`
--

CREATE TABLE IF NOT EXISTS `yq_length_class_description` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
--
-- Dumping data for table `yq_length_class_description`
--

INSERT INTO `yq_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
--
-- Table structure for table `yq_manufacturer`
--

CREATE TABLE IF NOT EXISTS `yq_manufacturer` (
...
--
-- Dumping data for table `yq_manufacturer`
--

INSERT INTO `yq_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `yq_manufacturer_to_store`
--

CREATE TABLE IF NOT EXISTS `yq_manufacturer_to_store` (
...
--
-- Dumping data for table `yq_manufacturer_to_store`
--

INSERT INTO `yq_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `yq_option`
--

CREATE TABLE IF NOT EXISTS `yq_option` (
...
--
-- Dumping data for table `yq_option`
--

INSERT INTO `yq_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 2),
(2, 'checkbox', 3),
(4, 'text', 4),
(5, 'select', 1),
...
--
-- Table structure for table `yq_option_description`
--

CREATE TABLE IF NOT EXISTS `yq_option_description` (
...
--
-- Dumping data for table `yq_option_description`
--

INSERT INTO `yq_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- Table structure for table `yq_option_value`
--

CREATE TABLE IF NOT EXISTS `yq_option_value` (
...
--
-- Dumping data for table `yq_option_value`
--

INSERT INTO `yq_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Table structure for table `yq_option_value_description`
--

CREATE TABLE IF NOT EXISTS `yq_option_value_description` (
...
--
-- Dumping data for table `yq_option_value_description`
--

INSERT INTO `yq_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- Table structure for table `yq_order`
--

CREATE TABLE IF NOT EXISTS `yq_order` (
...
--
-- Table structure for table `yq_order_download`
--

CREATE TABLE IF NOT EXISTS `yq_order_download` (
...
--
-- Table structure for table `yq_order_field`
--

CREATE TABLE IF NOT EXISTS `yq_order_field` (
  `order_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `custom_field_value_id` int(11) NOT NULL,
  `name` int(128) NOT NULL,
...
--
-- Table structure for table `yq_order_fraud`
--

CREATE TABLE IF NOT EXISTS `yq_order_fraud` (
  `order_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_order_history`
--

CREATE TABLE IF NOT EXISTS `yq_order_history` (
...
--
-- Table structure for table `yq_order_option`
--

CREATE TABLE IF NOT EXISTS `yq_order_option` (
...
--
-- Table structure for table `yq_order_product`
--

CREATE TABLE IF NOT EXISTS `yq_order_product` (
...
--
-- Table structure for table `yq_order_recurring`
--

CREATE TABLE IF NOT EXISTS `yq_order_recurring` (
...
--
-- Table structure for table `yq_order_recurring_transaction`
--

CREATE TABLE IF NOT EXISTS `yq_order_recurring_transaction` (
...
--
-- Table structure for table `yq_order_status`
--

CREATE TABLE IF NOT EXISTS `yq_order_status` (
...
--
-- Dumping data for table `yq_order_status`
--

INSERT INTO `yq_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
(5, 1, 'Complete'),
...
--
-- Table structure for table `yq_order_total`
--

CREATE TABLE IF NOT EXISTS `yq_order_total` (
...
--
-- Table structure for table `yq_order_voucher`
--

CREATE TABLE IF NOT EXISTS `yq_order_voucher` (
...
--
-- Table structure for table `yq_product`
--

CREATE TABLE IF NOT EXISTS `yq_product` (
...
--
-- Dumping data for table `yq_product`
--

INSERT INTO `yq_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `date_added`, `date_modified`, `viewed`) VALUES
...
(42, 'Product 15', '', '', '', '', '', '', '', 990, 5, 'data/demo/apple_cinema_30.jpg', 8, 1, '100.0000', 400, 9, '2009-02-04', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 2, 0, 1, '2009-02-03 21:07:37', '2011-09-30 00:46:19', 6),
...
--
-- Table structure for table `yq_product_attribute`
--

CREATE TABLE IF NOT EXISTS `yq_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL,
...
--
-- Dumping data for table `yq_product_attribute`
--

INSERT INTO `yq_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
--
-- Table structure for table `yq_product_description`
--

CREATE TABLE IF NOT EXISTS `yq_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `yq_product_description`
--

INSERT INTO `yq_product_description` (`product_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `tag`) VALUES
(35, 1, 'Product 8', '&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n', '', '', ''),
...
--
-- Table structure for table `yq_product_discount`
--

CREATE TABLE IF NOT EXISTS `yq_product_discount` (
...
--
-- Dumping data for table `yq_product_discount`
--

INSERT INTO `yq_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `yq_product_filter`
--

CREATE TABLE IF NOT EXISTS `yq_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_product_image`
--

CREATE TABLE IF NOT EXISTS `yq_product_image` (
...
--
-- Dumping data for table `yq_product_image`
--

INSERT INTO `yq_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `yq_product_option`
--

CREATE TABLE IF NOT EXISTS `yq_product_option` (
...
--
-- Dumping data for table `yq_product_option`
--

INSERT INTO `yq_product_option` (`product_option_id`, `product_id`, `option_id`, `option_value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Table structure for table `yq_product_option_value`
--

CREATE TABLE IF NOT EXISTS `yq_product_option_value` (
...
--
-- Dumping data for table `yq_product_option_value`
--

INSERT INTO `yq_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Table structure for table `yq_product_profile`
--

CREATE TABLE IF NOT EXISTS `yq_product_profile` (
  `product_id` int(11) NOT NULL,
  `profile_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_product_recurring`
--

CREATE TABLE IF NOT EXISTS `yq_product_recurring` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_product_related`
--

CREATE TABLE IF NOT EXISTS `yq_product_related` (
  `product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `yq_product_related`
--

INSERT INTO `yq_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Table structure for table `yq_product_reward`
--

CREATE TABLE IF NOT EXISTS `yq_product_reward` (
...
--
-- Dumping data for table `yq_product_reward`
--

INSERT INTO `yq_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
--
-- Table structure for table `yq_product_special`
--

CREATE TABLE IF NOT EXISTS `yq_product_special` (
...
--
-- Dumping data for table `yq_product_special`
--

INSERT INTO `yq_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `yq_product_to_category`
--

CREATE TABLE IF NOT EXISTS `yq_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `yq_product_to_category`
--

INSERT INTO `yq_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
--
-- Table structure for table `yq_product_to_download`
--

CREATE TABLE IF NOT EXISTS `yq_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
--
-- Table structure for table `yq_product_to_layout`
--

CREATE TABLE IF NOT EXISTS `yq_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`store_id`)
...
--
-- Table structure for table `yq_product_to_store`
--

CREATE TABLE IF NOT EXISTS `yq_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `yq_product_to_store`
--

INSERT INTO `yq_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Table structure for table `yq_profile`
--

CREATE TABLE IF NOT EXISTS `yq_profile` (
...
--
-- Table structure for table `yq_profile_description`
--

CREATE TABLE IF NOT EXISTS `yq_profile_description` (
  `profile_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `yq_return`
--

CREATE TABLE IF NOT EXISTS `yq_return` (
...
--
-- Table structure for table `yq_return_action`
--

CREATE TABLE IF NOT EXISTS `yq_return_action` (
...
--
-- Dumping data for table `yq_return_action`
--

INSERT INTO `yq_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
...
--
-- Table structure for table `yq_return_history`
--

CREATE TABLE IF NOT EXISTS `yq_return_history` (
...
--
-- Table structure for table `yq_return_reason`
--

CREATE TABLE IF NOT EXISTS `yq_return_reason` (
...
--
-- Dumping data for table `yq_return_reason`
--

INSERT INTO `yq_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Table structure for table `yq_return_status`
--

CREATE TABLE IF NOT EXISTS `yq_return_status` (
...
--
-- Dumping data for table `yq_return_status`
--

INSERT INTO `yq_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(3, 1, 'Complete'),
...
--
-- Table structure for table `yq_review`
--

CREATE TABLE IF NOT EXISTS `yq_review` (
...
CREATE TABLE IF NOT EXISTS `yq_setting` (
...
INSERT INTO `yq_setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES
...
(437, 0, 'config', 'config_encryption', '82f85c02c7eacb1916d2ae3fbfbc0976', 0),
...
(348, 0, 'config', 'config_template', 'ancart', 0),
...
(343, 0, 'config', 'config_email', 'zahidiubb@yahoo.com', 0),
...
--
-- Table structure for table `yq_stock_status`
--

CREATE TABLE IF NOT EXISTS `yq_stock_status` (
...
--
-- Dumping data for table `yq_stock_status`
--

INSERT INTO `yq_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order'),
(5, 1, 'Out Of Stock'),
(6, 1, '2 - 3 Days');
...
--
-- Table structure for table `yq_store`
--

CREATE TABLE IF NOT EXISTS `yq_store` (
...
--
-- Table structure for table `yq_tax_class`
--

CREATE TABLE IF NOT EXISTS `yq_tax_class` (
...
--
-- Dumping data for table `yq_tax_class`
--

INSERT INTO `yq_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `yq_tax_rate`
--

CREATE TABLE IF NOT EXISTS `yq_tax_rate` (
...
--
-- Dumping data for table `yq_tax_rate`
--

INSERT INTO `yq_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `yq_tax_rate_to_customer_group`
--

CREATE TABLE IF NOT EXISTS `yq_tax_rate_to_customer_group` (
...
--
-- Dumping data for table `yq_tax_rate_to_customer_group`
--

INSERT INTO `yq_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Table structure for table `yq_tax_rule`
--

CREATE TABLE IF NOT EXISTS `yq_tax_rule` (
...
--
-- Dumping data for table `yq_tax_rule`
--

INSERT INTO `yq_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- Table structure for table `yq_url_alias`
--

CREATE TABLE IF NOT EXISTS `yq_url_alias` (
...
--
-- Dumping data for table `yq_url_alias`
--

INSERT INTO `yq_url_alias` (`url_alias_id`, `query`, `keyword`) VALUES
...
--
-- Table structure for table `yq_user`
--

CREATE TABLE IF NOT EXISTS `yq_user` (
...
--
-- Dumping data for table `yq_user`
--

INSERT INTO `yq_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '8b0282e9d58cb6d14e73a4d859152f584125d629', '053d8b65d', '', '', 'zahidiubb@yahoo.com', '', '127.0.0.1', 1, '2014-06-20 13:57:01');

-- --------------------------------------------------------

--
-- Table structure for table `yq_user_group`
--

CREATE TABLE IF NOT EXISTS `yq_user_group` (
...
--
-- Dumping data for table `yq_user_group`
--

INSERT INTO `yq_user_group` (`user_group_id`, `name`, `permission`) VALUES
...
--
-- Table structure for table `yq_voucher`
--

CREATE TABLE IF NOT EXISTS `yq_voucher` (
...
--
-- Table structure for table `yq_voucher_history`
--

CREATE TABLE IF NOT EXISTS `yq_voucher_history` (
...
--
-- Table structure for table `yq_voucher_theme`
--

CREATE TABLE IF NOT EXISTS `yq_voucher_theme` (
...
--
-- Dumping data for table `yq_voucher_theme`
--

INSERT INTO `yq_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Table structure for table `yq_voucher_theme_description`
--

CREATE TABLE IF NOT EXISTS `yq_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
--
-- Dumping data for table `yq_voucher_theme_description`
--

INSERT INTO `yq_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
--
-- Table structure for table `yq_weight_class`
--

CREATE TABLE IF NOT EXISTS `yq_weight_class` (
...
--
-- Dumping data for table `yq_weight_class`
--

INSERT INTO `yq_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Table structure for table `yq_weight_class_description`
--

CREATE TABLE IF NOT EXISTS `yq_weight_class_description` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL,
...
--
-- Dumping data for table `yq_weight_class_description`
--

INSERT INTO `yq_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz');
...
--
-- Table structure for table `yq_zone`
--

CREATE TABLE IF NOT EXISTS `yq_zone` (
...
--
-- Dumping data for table `yq_zone`
--

INSERT INTO `yq_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- Table structure for table `yq_zone_to_geo_zone`
--

CREATE TABLE IF NOT EXISTS `yq_zone_to_geo_zone` (
...
--
-- Dumping data for table `yq_zone_to_geo_zone`
--

INSERT INTO `yq_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
