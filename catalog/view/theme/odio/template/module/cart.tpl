<div id="cart">
  ...
  <div class="content">
    ...
    <div class="checkout">
		<a class="button highlight" href="<?php echo $cart; ?>"><span class="icon-cart-white"><?php echo $text_cart; ?></span></a>&nbsp;&nbsp;
		<a class="button highlight" href="<?php echo $checkout; ?>"><span class="icon-checkout-white"><?php echo $text_checkout; ?></span></a>
	</div>
    <?php } else { ?>
