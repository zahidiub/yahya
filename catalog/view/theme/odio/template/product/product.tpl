...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="right" style="margin-left: <?php echo $this->config->get('config_image_thumb_width') + 52 ?>px;">
      ...
      <div class="review">
        <img src="catalog/view/theme/odio/image/icons/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /><a class="show-review" href="#tabs"><?php echo $reviews; ?></a>
      ...
      <div class="cart">
        <div>
          <button class="button highlight" id="button-cart"><span class="icon-cart-white"><?php echo $button_cart; ?></span></button>
        </div>
        <div>
  ...
  <div class="box-content">
    <div class="box-product product-grid">
      ...
      <div>
        ...
        <?php } ?>
        <div class="cart"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button"><span class="icon-cart-white"><?php echo $button_cart; ?></span></a></div>
