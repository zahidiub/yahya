...
<div id="ps_slider_late" class="ps_slider_late">
    <a class="prev disabled"></a>
    <a class="next disabled"></a>
    <div id="ps_albums_late">
       <?php foreach ($products as $product) { ?>
        <div class="ps_album_late" style="opacity:0;">
       ...
       <div class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
        ...
        <?php } ?>
		<div class="cart"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button"><span><?php echo $button_cart; ?></span></a></div></a></div>
        </div>
         <?php } ?> 
    </div>    
</div>
<script type="text/javascript">
            $(function() {
				...
				*/
				...
				var $ps_albums 		= $('#ps_albums_late');
				/**
				* number of albums available
				*/
				var elems			= $ps_albums.children().length;
				var $ps_slider		= $('#ps_slider_late');
